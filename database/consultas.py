...
def obtener_productos(conn):
    ...
    cursor.execute("""
        SELECT producto_id, modelo, precio
        FROM productos
...
# Función para obtener los productos junto con sus especificaciones técnicas

def obtener_productos_con_especificaciones(conn):
    cursor = conn.cursor()
    ...
    cursor.execute("""
        SELECT
            ...
            e.bus_memoria
        FROM productos p
        JOIN especificaciones_producto e
...
# Función para obtener un resumen de cada producto con sus especificaciones y distribución de valoraciones

def obtener_resumen_productos(conn):
    cursor = conn.cursor()
